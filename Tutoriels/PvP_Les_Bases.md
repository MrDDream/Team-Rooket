...
> Les combats peuvent être frustrants ; chaque équipe a ses faiblesses et même les meilleures peuvent perdre en raison d'erreurs ou de la force adverse. 
Concevoir et maîtriser une équipe équilibrée enrichit votre expérience de jeu. Les meilleurs joueurs sont ceux qui apprennent de leurs erreurs. 
N'oubliez pas que l'objectif principal du PvP est de s'amuser !
{.is-info}
...
> La première étape pour créer votre équipe est de décider quel tier vous voulez jouer. Certains Pokémon ont des stats plus élevées ou sont simplement plus puissants. 
...
![cizayox.gif](/images/tutoriels/cizayox.gif) ![motisma.gif](/images/tutoriels/motisma.gif)
...
On y retrouve des Pokémon comme :
**Mackogneur** / **Crocorible**
![mackogneur.gif](/images/tutoriels/mackogneur.gif) ![crocorible.gif](/images/tutoriels/crocorible.gif)

> **NU (NeverUsed)** regroupe les Pokémon les moins puissants, de nombreux Pokémon bannis se retrouvent ici, ainsi que des sous-évolutions.
{.is-success}

Comme par exemple:
**Parasect** / **Poissoroy** / **Togetic** / **Excelangue**
![parasect.gif](/images/tutoriels/parasect.gif) ![poissoroy.gif](/images/tutoriels/poissoroy.gif) ![togetic.gif](/images/tutoriels/togetic.gif) ![excelangue.gif](/images/tutoriels/excelangue.gif)


> Il existe également des matchs en **Doubles (2vs2)** et des matchs **Random**, où une équipe de 6 Pokémon aléatoires vous sera donnée. ***C'est un excellent moyen pour les débutants de se lancer dans le PvP.***
{.is-info}

## 3) Les Clauses

Il s'agit des règles de PvP pour PokéMMO (et pour beaucoup de jeu de la licence).
...
> Une erreur classique chez les nouveaux joueurs est de vouloir créer une équipe en fonction des types (ex : besoin d'un type eau, un feu, etc.). 
En compétitif, il faut penser en termes de **RÔLES** dans l'équipe (Sweeper, Staller, etc.) et de **CONTRES**.
Le **OU** permet de prévoir les Pokémon souvent rencontrés et de les contrer efficacement *(exemple : Aquali est un bon contre à Arcanin)*.
{.is-warning}

> Les **Sweeper** ***(SWEEPER)*** sont généralement utilisés afin de contrer les stallers adverses. Par exemple, un sweeper physique efficace a pour rôle de contrer les éventuels stallers spéciaux de l'équipe adverse (son utilité sera moindre sur un staller physique).
{.is-success}

> Les **Stallers** ***(STALLER)*** sont des murs qui encaissent les attaques tout en plaçant des picots, se régénérant ou infligeant des statuts (Toxik, etc.).
{.is-success}

Les meilleurs murs spéciaux incluent :
**Leuphorie** / **Ronflex** / **Noctali**
![leuphorie.gif](/images/tutoriels/leuphorie.gif) ![ronflex.gif](/images/tutoriels/ronflex.gif)   ![noctali.gif](/images/tutoriels/noctali.gif)

Les meilleurs murs physiques incluent :
**Airmure** / **Smogogo** / **Foretress**
![airmure.gif](/images/tutoriels/airmure.gif) ![smogogo.gif](/images/tutoriels/smogogo.gif) ![foretress.gif](/images/tutoriels/foretress.gif)


> Les **Tanks** ***(TANK)*** sont des Pokémon avec une bonne attaque et beaucoup de PV/défenses, mais leur vitesse est souvent faible. Ils jouent un rôle hybride entre le Staller et le Sweeper.
{.is-success}

Exemples : **Ronflex** / **Aquali** / **Lokhlass**
![ronflex.gif](/images/tutoriels/ronflex.gif) ![aquali.gif](/images/tutoriels/aquali.gif) ![lokhlass.gif](/images/tutoriels/lokhlass.gif)
...
Réaliser un réseau de résistances efficace vous permettra de répondre de manière solide à toutes les menaces que pourra envoyer votre adversaire.

Dans l'idéal cette synergie doit se refléter au niveau des attaques et de la distribution d'EVs des membres de votre équipe. 
...
Avoir des checks et contres face à toutes les menaces est essentiel pour éviter de perdre trop de Pokémon, essayez de ne pas sacrifier vos membres inutilement.
